...
-- Χρόνος δημιουργίας: 06 Ιαν 2015 στις 22:50:21
...
(1, 'admin', 'admin', 1, ''),
(2, 'user1', 'user1', 0, 'Γεώργιος'),
(4, 'user3', 'user3', 0, 'Ιωάννης'),
(5, 'user2', 'user2', 0, 'Φίλιππος');
